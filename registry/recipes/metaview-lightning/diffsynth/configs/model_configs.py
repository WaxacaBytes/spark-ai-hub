qwen_image_series = [
    {
        ...
        "model_name": "metaview_dit",
        # "model_class": "diffsynth.models.qwen_image_dit.QwenImageDiT", 
        "model_class": "src.MetaView_dit.MetaViewDiT",
        # "extra_kwargs": {'add_attn_type': 'prope_attn'},
        # "extra_kwargs": {'add_attn_type': 'cross_attn', 'add_in_dim': 3072},
        # "extra_kwargs": {'add_attn_type': 'self_attn_3D', 'add_in_dim': 3072},
        # "extra_kwargs": {'add_attn_type': 'self_attn_3D', 'add_in_dim': 4096},
        # "extra_kwargs": {'add_attn_type': 'self_attn_lora_3D', 'add_in_dim': 3072, 'lora_rank': 256},
        # "extra_kwargs": {'add_attn_type': 'self_attn_lora_3D', 'merge_3D': True, '_3d_dim': 6144,  'add_in_dim': 3072, 'lora_rank': 256},
        # "extra_kwargs": {'add_attn_type': 'self_attn_3D', 'merge_3D': True, '_3d_dim': 3072, 'add_in_dim': 3072},
        # "extra_kwargs": {'add_attn_type': 'self_attn_3D', 'merge_3D': True, '_3d_dim': 4096, 'add_in_dim': 3072},
        
        "extra_kwargs": {'add_attn_type': 'self_attn_3D', 'merge_3D': True, '_3d_dim': 6144, 'add_in_dim': 3072},
        # "extra_kwargs": {'add_attn_type': 'self_attn_3D', 'merge_3D': True, 'decode_3D': True, '_3d_dim': 4096, 'add_in_dim': 3072},
    },
    {
...
flux_series = [
    {
        ...
        "model_name": "flux_dit",
        "model_class": "src.flux_kontext_dit.FluxDiTKontext",
